...
#from fsp.evaluate.fspaccuracy import verify_accuracy_fsp


absPath = Path(".").cwd() / "test" / "benchmark" / "fsp"


# def test_accuracy_fsp_defaultopt_dmcase2_dist_scypy_st_kmeans_mt():
...
# def test_accuracy_fsp_dmcase1_dist_scipy_st_kmeans_mt():
#     result, outputFile = verify_accuracy_fsp(dataset_filenames=["Iris"], opts={"deterministicResult":Options(dm_case=1, kmeans_random_state=42)}, input_dataset_path=absPath, output_report_path=absPath)
#     assert os.path.exists(outputFile)
#     assert len(result) == 1
#     assert sum(1 for _ in open(outputFile)) == 2
...
# def test_accuracy_fsp_dmcase1_dist_sklearn_mt_kmeans_mt():
#     result, outputFile = verify_accuracy_fsp(dataset_filenames=["Iris"], opts={"deterministicResult":Options(dm_case=1, distance_method=2, kmeans_random_state=42)}, input_dataset_path=absPath, output_report_path=absPath)
#     assert os.path.exists(outputFile)
#     assert len(result) == 1
#     assert sum(1 for _ in open(outputFile)) == 2
...
# def test_accuracy_fsp_dmcase2_dist_sklearn_mt_kmeans_mt():
#     result, outputFile = verify_accuracy_fsp(dataset_filenames=["Iris"], opts={"deterministicResult":Options(kmeans_random_state=42, distance_method=2)}, input_dataset_path=absPath, output_report_path=absPath)
#     assert os.path.exists(outputFile)
#     assert len(result) == 1
#     assert sum(1 for _ in open(outputFile)) == 2
...
# def test_accuracy_fsp_defaultopt_one_base_one_option():
...
# def test_accuracy_fsp_defaultopt_one_base_two_options():
...
# def test_accuracy_fsp_defaultopt_two_base_one_option():
...
# def test_accuracy_fsp_defaultopt_two_base_two_options():
